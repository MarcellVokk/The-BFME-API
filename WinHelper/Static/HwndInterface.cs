namespace WinHelper.Static
{
    ...
    internal static class HwndInterface
    {
        ...
        {
            WinHelper.Types.RECT lpRect = new WinHelper.Types.RECT();
        ...
        [DllImport("user32.dll")]
        private static extern bool GetWindowRect(IntPtr hWnd, out WinHelper.Types.RECT lpRect);
