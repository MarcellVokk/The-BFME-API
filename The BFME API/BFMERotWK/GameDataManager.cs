...
namespace The_BFME_API.BFMERotWK
{
    internal static class GameDataManager
    {
        public static string GetGameInstallDirectory()
        {
            try
            {
                RegistryKey? key = Registry.LocalMachine.OpenSubKey(@$"SOFTWARE\WOW6432Node\Electronic Arts\Electronic Arts\The Lord of the Rings, The Rise of the Witch-king", false);
